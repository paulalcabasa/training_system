...
<div id="container">
	...
	<div class="page-wrapper">	
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation" id="btn_job"  class="disabled">
		...
		<div class="tab-content">
			...
			<div class="col-md-6"> <!-- left side -->
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
					    <span class="btn btn-primary btn-sm btn-file" style="width:30%;">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control col-sm-9" maxlength="45" id="txt_fname" name="txt_fname" placeholder="First Name"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control  " id="txt_mname" maxlength="45" name="txt_mname" placeholder="Middle Name"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control  " id="txt_lname" maxlength="45" name="txt_lname" placeholder="Last Name"/>
						<span class="glyphicon glyphicon-remove form-control-feedback" style="display:none;" aria-hidden="true"></span>
				...
				<div class="form-group">
					<label for="txt_lname" class="control-label col-sm-3">Nickname</label>
					<div class="col-sm-9">
						<input type="text" class="form-control  " id="txt_nickname" maxlength="45" name="txt_nickname" placeholder="Nickname"/>
						<span class="glyphicon glyphicon-remove form-control-feedback" style="display:none;" aria-hidden="true"></span>
						<p class="help-block custom-help" style="display:none;"><strong>*</strong> Please enter nickname</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
		                <div class='input-group date' id="txt_date_of_birth">
		                    <input type='text'  name="txt_date_of_birth" class="form-control  " placeholder="Date of Birth"/>
			...
			<div role="tabpanel" id="panel-job-details" class="tab-pane fade"> <!-- start of second tab -->
				...
				<div class="col-md-6"> <!-- start of left side -->
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<select class="form-control  " id="txt_highest_educ_att" name="txt_highest_educ_att">
							<?php
								foreach($list_of_education as $education){
									$education = (object)$education;
							?>
								<option value="<?php echo $education->id; ?>"><?php echo $education->education_desc; ?></option>
							<?php
								}
							?>
							</select>
						...
						<div class="col-sm-9">
							...
							<?php
								foreach($list_of_dealers as $d){
									$d = (object)$d;
							?>
								<option value="<?php echo $d->id; ?>"><?php echo $d->dealer_name; ?></option>
							<?php
								}
							?>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class='input-group date' id="txt_date_hired">
								<input type='text' class="form-control" name="txt_date_hired" placeholder="Date Hired" />
								<span class="input-group-addon">
			...
			<div role="tabpanel" id="panel-contact" class="tab-pane fade"> <!-- start of third tab -->
				...
				<div class="col-md-6"> <!-- start of left side -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control  " id="txt_office" name="txt_office" placeholder="(XXX) XXX-XXXX" />
							<span class="glyphicon glyphicon-remove form-control-feedback" style="display:none;" aria-hidden="true"></span>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="email" class="form-control  " id="txt_email" name="txt_email" placeholder="Email address"/>
							<span class="glyphicon glyphicon-remove form-control-feedback" style="display:none;" aria-hidden="true"></span>
...
$(document).ready(function(){
   ...
   // computeDPYear("#txt_date_hired","#txt_length_of_service","years");
    	...
    	$.ajax({
    		...
    		success:function(response){
    			if(response == "success"){
    				...
    				alert("ERROR CODE AT1: Sorry but the system has encountered an unexpected error, please contact the systems administrator " + response);
    			}
    		}
    	});
	...
	$("#cbo_province").change(function(){
		...
		$.ajax({
			type:"POST",
			data:{
				province_id : $("#cbo_province").val()
			},
			url:"ajax/get_municipality.php",
			success:function(response){
	...
	*/
	...
	$("#txt_highest_educ_att").select2({ width: '100%' });
